...
const lawthmic_news = [
    ...
    },
    {
        id: 34,
        kind: '[형사]',
        date: '대법원 2013. 8. 23. 선고 2013도4004 판결',
        tag: '전자금융거래법·접근매체의 양수·명의자',
        content: '전자금융거래법에 따른 접근매체의 양수는 양도인의 의사에 기하여 접근매체의 소유권 내지 처분권을 확정적으로 이전받는 것을 의미하고, 단지 대여받거나 일시적인 사용을 위한 위임을 받는 행위는 이에 포함되지 않는다. 또한 접근매체의 양도, 양수행위의 주체에 제한이 없으므로 반드시 접근매체의 명의자가 양도하거나 명의자로부터 양수한 경우에만 처벌되는 것은 아니다.'
    }
]
