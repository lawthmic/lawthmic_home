...
const lawthmic_news = [
    ...
    },
    {
        ...
        tag: '양형부당·상고이유',
        content: '형사소송법 383조 4호 후단이 정한 양형부당의 상고이유는 10년 이상의 징역이나 금고 등의 형을 선고받은 피고인의 이익을 위한 것이며, 검사는 피고인에게 불리하게 원심의 양형이 가볍다거나 원심이 양형의 전제사실을 인정하는 데 자유심증주의의 한계를 벗어난 잘못이 있다는 사유를 상고이유로 주장할 수 없다.'
    }
]
